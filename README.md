...
4. [Cálculo distancia a zonas de ocio, distancia a radares y día festivo](#id4)
...
## Cálculo distancia a zonas de ocio, distancia a radares y día festivo <a name="id4"></a>
...
Por último hemos extraído latitud y longitud del dataset de radares, días festivos del dataset calendario, y hemos unido todos los datasets en un mismo Notebook:  
